...
<body> 
	...
	<!-- Top box -->
		...
		<div class="placeholder">
			<div class="parallax-window" data-parallax="scroll" data-image-src="img/5.jpeg">
				<div class="tm-header">
					<div class="row tm-header-inner">
						<div class="col-md-6 col-12">
							<img src="img/simple-house-logo.png" alt="Logo" class="tm-site-logo" /> 
							<div class="tm-site-text-box">
								<h1 class="tm-site-title">KD's Photolabs</h1>
								<h6 class="tm-site-description">THE PHOTOGRAPHER</h6>	
							</div>
						</div>
		...
		<main>
			<header class="row tm-welcome-section">
				<h2 class="col-12 text-center tm-section-title">About KD's Photolabs</h2>
				<p class="col-12 text-center">We are Professtional in our Field.We Make your idea in one Photoframe. </p>
			</header>
				...
				<div class="row">
					<article class="col-lg-6">
						<figure class="tm-person">
                                                    <img src="img/k1.jpeg" alt="Image" class="img-fluid tm-person-img" />
							<figcaption class="tm-person-description">
								<h4 class="tm-person-name">Arsh Mansuri</h4>
								<p class="tm-person-title">Pose</p>
					...
					<article class="col-lg-6">
						<figure class="tm-person">
                                                    <img src="img/k3.jpeg" alt="Image" class="img-fluid tm-person-img" />
							<figcaption class="tm-person-description">
					...
					<article class="col-lg-6">
						<figure class="tm-person">
                                                    <img src="img/k4.jpeg" alt="Image" class="img-fluid tm-person-img" />
							<figcaption class="tm-person-description">
					...
					<article class="col-lg-6">
						<figure class="tm-person">
                                                    <img src="img/kk1.png" alt="Image" class="img-fluid tm-person-img" />
							<figcaption class="tm-person-description">
